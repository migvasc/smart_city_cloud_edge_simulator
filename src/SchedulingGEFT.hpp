...
public:
    SchedulingGEFT(map<string, int> *hosts_cpu_availability,std::map<std::string, double> *hosts_renewables, std::map<std::string, double> *hosts_energy,std::map<std::string, LithiumIonBattery*> *hosts_bat,std::unordered_map<std::string, string> *task_cache);
