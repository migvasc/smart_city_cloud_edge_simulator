...
dict_baseline  = load_requests_summary('output/output_baseline_toulouse_100k/')
dict_heft =         load_requests_summary('output/output_heft_toulouse_100k/')
dict_lcaheft_fr =   load_requests_summary('output/output_co2_volume_toulouse_100k/')
dict_lcaheft_swe =  load_requests_summary('output/output_co2_volume_toulouse_100k_2/')
dict_lcaheft_usa =  load_requests_summary('output/output_co2_volume_toulouse_100k_3/')
dict_cloud_only =   load_requests_summary('output/output_cloud_only_toulouse_100k/')                                                                                                                                                                                 
